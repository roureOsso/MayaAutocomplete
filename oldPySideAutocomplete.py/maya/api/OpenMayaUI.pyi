...
class MDrawRequest(object):
    ...
    displayCullOpposite : getset_descriptor
    
    displayCulling : getset_descriptor
    
    displayStatus : getset_descriptor
    
    displayStyle : getset_descriptor
    
    drawData : getset_descriptor
    
    drawLast : getset_descriptor
    
    isTransparent : getset_descriptor
    
    material : getset_descriptor
    
    matrix : getset_descriptor
    
    multiPath : getset_descriptor
    
    token : getset_descriptor
    
    view : getset_descriptor
...
class RenderParameters(object):
    ...
    baseColor : getset_descriptor
    
    showAlphaMask : getset_descriptor
    
    unfiltered : getset_descriptor
...
class ShaderContext(object):
    ...
    shadingEngine : getset_descriptor
...
class MTextureEditorDrawInfo(object):
    ...
    drawingFunction : getset_descriptor
...
class MPxHardwareShader(_MPxNode):
    ...
    outColorB : OpenMaya.MObject
    
    outColorG : OpenMaya.MObject
    
    outColorR : OpenMaya.MObject
...
class MPxLocatorNode(_MPxNode):
    ...
    boundingBoxCenterX : OpenMaya.MObject
    
    boundingBoxCenterY : OpenMaya.MObject
    
    boundingBoxCenterZ : OpenMaya.MObject
    
    center : OpenMaya.MObject
    
    instObjGroups : OpenMaya.MObject
    
    intermediateObject : OpenMaya.MObject
    
    inverseMatrix : OpenMaya.MObject
    
    isTemplated : OpenMaya.MObject
    
    localPosition : OpenMaya.MObject
    
    localPositionX : OpenMaya.MObject
    
    localPositionY : OpenMaya.MObject
    
    localPositionZ : OpenMaya.MObject
    
    localScale : OpenMaya.MObject
    
    localScaleX : OpenMaya.MObject
    
    localScaleY : OpenMaya.MObject
    
    localScaleZ : OpenMaya.MObject
    
    matrix : OpenMaya.MObject
    
    nodeBoundingBox : OpenMaya.MObject
    
    nodeBoundingBoxMax : OpenMaya.MObject
    
    nodeBoundingBoxMaxX : OpenMaya.MObject
    
    nodeBoundingBoxMaxY : OpenMaya.MObject
    
    nodeBoundingBoxMaxZ : OpenMaya.MObject
    
    nodeBoundingBoxMin : OpenMaya.MObject
    
    nodeBoundingBoxMinX : OpenMaya.MObject
    
    nodeBoundingBoxMinY : OpenMaya.MObject
    
    nodeBoundingBoxMinZ : OpenMaya.MObject
    
    nodeBoundingBoxSize : OpenMaya.MObject
    
    nodeBoundingBoxSizeX : OpenMaya.MObject
    
    nodeBoundingBoxSizeY : OpenMaya.MObject
    
    nodeBoundingBoxSizeZ : OpenMaya.MObject
    
    objectColor : OpenMaya.MObject
    
    objectGroupColor : OpenMaya.MObject
    
    objectGroupId : OpenMaya.MObject
    
    objectGroups : OpenMaya.MObject
    
    objectGrpCompList : OpenMaya.MObject
    
    parentInverseMatrix : OpenMaya.MObject
    
    parentMatrix : OpenMaya.MObject
    
    underWorldObject : OpenMaya.MObject
    
    useObjectColor : OpenMaya.MObject
    
    visibility : OpenMaya.MObject
    
    worldInverseMatrix : OpenMaya.MObject
    
    worldMatrix : OpenMaya.MObject
    
    worldPosition : OpenMaya.MObject
    
    worldPositionX : OpenMaya.MObject
    
    worldPositionY : OpenMaya.MObject
    
    worldPositionZ : OpenMaya.MObject
...
class MSelectInfo(MDrawInfo):
    ...
    highestPriority : getset_descriptor
...
class MPxHwShaderNode(_MPxNode):
    ...
    outGlowColor : OpenMaya.MObject
    
    outGlowColorB : OpenMaya.MObject
    
    outGlowColorG : OpenMaya.MObject
    
    outGlowColorR : OpenMaya.MObject
    
    outMatteOpacity : OpenMaya.MObject
    
    outMatteOpacityB : OpenMaya.MObject
    
    outMatteOpacityG : OpenMaya.MObject
    
    outMatteOpacityR : OpenMaya.MObject
    
    outTransparency : OpenMaya.MObject
    
    outTransparencyB : OpenMaya.MObject
    
    outTransparencyG : OpenMaya.MObject
    
    outTransparencyR : OpenMaya.MObject
...
class MFnManip3D(_MFnTransform):
    ...
    isOptimizePlaybackOn : getset_descriptor
    
    isVisible : getset_descriptor
    
    manipScale : getset_descriptor
...
class MFnToggleManip(MFnManip3D):
    ...
    startPoint : getset_descriptor
    
    toggle : getset_descriptor
...
class MFnPointOnSurfaceManip(MFnManip3D):
    ...
    isDrawSurfaceOn : getset_descriptor
    
    uParam : getset_descriptor
    
    vParam : getset_descriptor
...
class MFnPointOnCurveManip(MFnManip3D):
    ...
    isDrawCurveOn : getset_descriptor
    
    parameter : getset_descriptor
...
class MFnCurveSegmentManip(MFnManip3D):
    ...
    endParameter : getset_descriptor
    
    startParameter : getset_descriptor
...
class MFnFreePointTriadManip(MFnManip3D):
    ...
    isDrawAxesOn : getset_descriptor
    
    isKeyframeAllOn : getset_descriptor
    
    isSnapModeOn : getset_descriptor
...
class MFnScaleManip(MFnManip3D):
    ...
    orientationMode : getset_descriptor
    
    snapIncrement : getset_descriptor
...
class MFnDistanceManip(MFnManip3D):
    ...
    isDrawLineOn : getset_descriptor
    
    isDrawStartOn : getset_descriptor
    
    scalingFactor : getset_descriptor
